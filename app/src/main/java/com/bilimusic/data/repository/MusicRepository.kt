...
class MusicRepository @Inject constructor(
    ...
    suspend fun getAllPlaylistsOnce(): List<Playlist> = musicDao.getAllPlaylistsOnce()
    ...
    suspend fun removeRecentPlayById(songId: String) = musicDao.removeRecentPlayById(songId)
